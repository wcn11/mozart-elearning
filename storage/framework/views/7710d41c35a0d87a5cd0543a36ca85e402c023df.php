              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                   ...
                   <form method="POST" action="<?php echo e(route('student.login')); ?>" aria-label="<?php echo e(__('Login')); ?>">
                        <?php echo csrf_field(); ?>
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo e(route('student.register')); ?>">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/student/auth/login.blade.php ENDPATH**/ ?>