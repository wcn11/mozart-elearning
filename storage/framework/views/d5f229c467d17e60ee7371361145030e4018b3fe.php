...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url(<?php echo e(URL::to('images/mentor.jpg')); ?>);"></div>
        ...
        <form method="POST" action="<?php echo e(route('mentor.register')); ?>" aria-label="<?php echo e(__('Register')); ?>">
          ...
          <div class="text-center">
              ...
              <a class="btn btn-link" href="<?php echo e(route('mentor.password.request')); ?>">
...
</html><?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/mentor/auth/register.blade.php ENDPATH**/ ?>