...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="template_fe/css/bootstrap.min.css">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="template_fe/css/themify-icons.css">
    <!-- Owl carousel -->
...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.html"><img src="template_fe/images/logo.png" class="img-fluid" alt="logo"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"> <a class="nav-link active" href="#home">Beranda <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link" href="#features">Projek</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="#gallery">Pelajaran</a> </li>
    ...
    <header class="bg-gradient" id="home">
        ...
        <div class="img-holder mt-3"><img src="template_fe/images/iphonex.png" alt="phone" class="img-fluid"></div>
    </header>

    <div class="client-logos my-5">
        <div class="container text-center">
            <img src="template_fe/images/client-logos.png" alt="client logos" class="img-fluid">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="template_fe/images/perspective.png" alt="perspective phone" class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="template_fe/images/graphic.png" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                        <div>
    ...
    <div class="section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="template_fe/images/dualphone.png" alt="dual phone" class="img-fluid">
                </div>
    ...
    <div class="section light-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="template_fe/images/iphonex.png" alt="iphone" class="img-fluid">
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">
                <div class="testimonials-single">
                    <img src="template_fe/images/client.png" alt="client" class="client-img">
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            ...
            <div class="img-gallery owl-carousel owl-theme">
                <img src="template_fe/images/screen1.jpg" alt="image">
                <img src="template_fe/images/screen2.jpg" alt="image">
                <img src="template_fe/images/screen3.jpg" alt="image">
                <img src="template_fe/images/screen1.jpg" alt="image">
            </div>
        ...
        <div class="container">
            <div class="call-to-action">
                ...
                <div class="my-4">
                    ...
                    <a href="#" class="btn btn-light"><img src="template_fe/images/appleicon.png" alt="icon"> App Store</a>
                    <a href="#" class="btn btn-light"><img src="template_fe/images/playicon.png" alt="icon"> Google play</a>
                </div>
    ...
    <script src="template_fe/js/jquery-3.2.1.min.js"></script>
    <script src="template_fe/js/bootstrap.bundle.min.js"></script>
    <!-- Plugins JS -->
...
<?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/layouts/app.blade.php ENDPATH**/ ?>