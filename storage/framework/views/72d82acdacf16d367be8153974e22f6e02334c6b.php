...
<div class="container-fluid ">
    ...
    <div class="card shadow mb-4">
        <form class="form form-soal" action="<?php echo e(route('mentor.soal_update')); ?>" class="col-md-12" method="POST">
            ...
            <input type="hidden" name="soal_id[]" value="<?php echo e($soal[$i]['id']); ?>">
                ...
                <div class="row"> 
                    <div class="col-md-6 grid-margin"> 
                        ...
                        <div class="form-group"> 
                            ...
                            <select class="form-control" name="pilihan_benar[]" required="required"> 
                                <?php for($a = 0; $a < 5; $a++): ?>
                                    <option value="<?php echo e($a+1); ?>"  <?php echo e($soal[$a]['pilihan_benar'] === $a+1 ? "selected='selected'" : ''); ?>>Pilihan <?php echo e($a+1); ?></option>
                                <?php endfor; ?>
                            </select> 
                    ...
                    <div class="col-md-6 grid-margin"> 
                        <div class="card shadow"> 
                            <div class="card-body"> 
                                <h4 class="card-title">Penjelasan Jawaban Benar soal ke <?php echo e($i +1); ?>  </h4> 
...
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/mentor/pages/question/question_edit.blade.php ENDPATH**/ ?>