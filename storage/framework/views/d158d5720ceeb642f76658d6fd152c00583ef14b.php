      ...
      <li class="nav-item">
        ...
        <div id="pelajaran" class="collapse" aria-labelledby="headingTwo">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('student.pelajaran')); ?>">Pelajaran</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo e(url('/images/'.Auth::guard('student')->user()->foto)); ?>">
              </a>
...
<?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/student/layouts/app.blade.php ENDPATH**/ ?>