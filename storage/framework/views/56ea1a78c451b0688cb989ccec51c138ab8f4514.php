    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="<?php echo e(route('mentor.soal')); ?>">
            ...
            <li class="pcoded-hasmenu">
                <a href="<?php echo e(route('mentor.daftar_materi')); ?>">
                    <span class="pcoded-micon"><i class="feather icon-layers"></i></span>
...
</nav><?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/mentor/layouts/_partials/_sidebar.blade.php ENDPATH**/ ?>