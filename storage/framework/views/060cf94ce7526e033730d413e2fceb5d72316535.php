            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo e(route('student.login')); ?>">Buat sebuah akun!</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="<?php echo e(route('student.register')); ?>">Sudah punya akun? Login!</a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/student/auth/passwords/email.blade.php ENDPATH**/ ?>