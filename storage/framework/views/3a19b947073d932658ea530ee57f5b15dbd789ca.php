                    ...
                    <div class="col-md-6 grid-margin">
                        <div class="card" style="border:0;">
                            <div class="card-body">
                                ...
                                <input type='file' name="file" value="<?php echo e($student->foto); ?>" id="inputFile" />
                    
                            <img id="image_upload_preview" src="<?php echo e(url('images/'. $student->foto)); ?>" class="rounded-circle gambar" alt="your image" />
...
<?php echo $__env->make('student.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/student/profil.blade.php ENDPATH**/ ?>