    ...
    <div class="card shadow mb-4 form-buat-soal">
        ...
        <div class="card-body">
            <div class="table-responsive w-100" style="overflow:hidden;">
                <form class="form form-tambah-soal" action="<?php echo e(route('mentor.question_create_title')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Desktop/mozart-elearning/resources/views/mentor/pages/question/index.blade.php ENDPATH**/ ?>