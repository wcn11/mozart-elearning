      ...
      <li class="nav-item">
        ...
        <div id="pelajaran" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('mentor.pelajaran')); ?>">Pelajaran</a>
          </div>
        </div>
      </li>
...
<?php /**PATH C:\Users\wahyu\Desktop\mozart-learn\resources\views/mentor/layouts/app.blade.php ENDPATH**/ ?>