                ...
                {{ $nomor }}. {{ $soal->pertanyaan }}<br>
                    <div class="form-check form-soal" data-link="{{ route('student.soal_update', $soal->id) }}">
                        @if ($hasil[0]['jawaban'] == 1)
                            <input class="form-check-input jawaban1 jawaban" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" checked id="exampleRadios1" value="1">
                        @else
                            <input class="form-check-input jawaban1 jawaban" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" id="exampleRadios1" value="1">
                        @endif
                    ...
                    <div class="form-check">
                        @if ($hasil[0]['jawaban'] == 2)
                            <input class="form-check-input jawaban2" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" checked id="exampleRadios2" value="2">
                        @else
                    ...
                    <div class="form-check">
                        @if ($hasil[0]['jawaban'] == 3)
                            <input class="form-check-input jawaban3" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" checked id="exampleRadios3" value="3">
                        @else
                            <input class="form-check-input jawaban3" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban"  id="exampleRadios3" value="3">
                        @endif
                    ...
                    <div class="form-check">
                        @if ($hasil[0]['jawaban'] == 4)
                            <input class="form-check-input jawaban4" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" checked id="exampleRadios4" value="4">
                        @else
                    ...
                    <div class="form-check">
                        @if ($hasil[0]['jawaban'] == 5)
                            <input class="form-check-input jawaban5" data-param="{{ Crypt::encrypt($soal_judul->id) }}" type="radio" name="jawaban" checked id="exampleRadios5" value="5">
                        @else
