...
<head>
    ...
    {{-- load file bootstrap (untuk mempercantik tampilan aja) --}}
...
<body>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <select name="lama_hari" class="w-100">
                ...
                @for($i = 1; $i <= 20; $i++)
                    {{-- buat perulangan untuk kasih nilai option --}}
    ...
    {{-- buat input hidden untuk menampung nilai dari harga awal --}}
    <input type="hidden" name="harga" value="25000">

    {{-- inputan hidden ini yang akan dikirim ke controller buat di masukkin ke database--}}
    <input type="hidden" name="total_harga">
    
    {{-- untuk load data jquery --}}
    {{-- PENTING!!! KALAU ENGGA ADA JQUERY, SCRIPT ENGGA AKAN JALAN --}}
    {{-- TAPI kalau di lu JQUERY sama bootstrapnya udah ada, di hapus yang ini dua duanya--}}
